...
export const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 px-8 flex flex-col items-center text-center overflow-hidden">
      ...
      {/* CTA Button */}
      <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-200 mb-6">
        Start for free
      ...
      <p className="text-xs font-bold tracking-widest text-slate-400 uppercase">
        ...
        <div className="relative z-10 w-full aspect-[16/10] bg-white rounded-xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] border border-slate-200/80 flex flex-col overflow-hidden text-left">
        ...
        <div className="absolute -left-12 bottom-24 z-20 bg-white/80 backdrop-blur-xl border border-white p-4 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] w-64 animate-[bounce_6s_infinite] shadow-blue-500/10">
        ...
        <div className="absolute -right-16 top-32 z-20 bg-white/90 backdrop-blur-xl border border-white p-5 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] w-72 animate-[bounce_7s_infinite_1s] shadow-blue-500/10">
