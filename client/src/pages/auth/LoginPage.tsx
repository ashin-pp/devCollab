        ...
        <div className="relative z-10">
          ...
          <div className="bg-white/80 backdrop-blur-md border border-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 max-w-md relative">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="text-sm font-bold text-slate-900">Frontend Masters</div>
                <div className="text-xs text-slate-500">VP Engineering @ TechFlow</div>
              </div>
            </div>
            <p className="text-sm text-slate-700 italic leading-relaxed">
              "DevCollab has completely transformed how our engineering team ships code. The integrated AI is a game-changer."
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 relative">
        ...
        <div className="absolute top-8 left-8 right-8 flex justify-between items-center hidden sm:flex">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-900">Secure Authentication</div>
              <div className="text-[10px] font-semibold text-slate-400 tracking-wider uppercase">Identity Verification</div>
            </div>
          </div>
          <div className="px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-[10px] font-bold tracking-widest uppercase border border-emerald-100">
        ...
        <div className="w-full max-w-[420px] mt-12 lg:mt-0">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 font-medium">Enter your credentials to access your workspace.</p>
          </div>
          ...
          <button 
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 rounded-xl hover:bg-slate-50 transition-colors mb-6 shadow-sm disabled:opacity-50"
          >
